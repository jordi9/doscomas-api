...
class ItemShould :
  ScenarioStringSpec<GivenItem, WhenItem, ThenItem, ItemContext>({
    ...
    "create an item" {
      ...
      Then
        ...
        .and()
        .`the item has name`("Buy milk")
        .and()
        .`the item has description`("From the store")
        .and()
        .`a notification was sent`("Item created: Buy milk")
    }
    ...
    "return items after creating them" {
      Given
        .`an item exists`("First item")
        .and()
        .`an item exists`("Second item")
      When.`listing all items`()
      Then
        .`the response is successful`()
        .and()
        .`items are returned`(2)
    }
    ...
    "return an item by id" {
      ...
      Then
        .`the response is successful`()
        .and()
        .`the item has name`("Test item")
        .and()
        .`the item has description`("Some description")
    }
